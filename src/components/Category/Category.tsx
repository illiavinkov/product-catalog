      ...
      <div className="category__content">
        ...
        <div className="category__images">
          ...
          >
            ...
            <h2 className="image__title">Mobile phones</h2>

            <p className="image__subtitle">{`${phones.length} models`}</p>
          </div>

          <div className="category__image" data-cy="categoryLinksContainer">
            <Link to="/tablets">
              <img src={tablets} alt="tablets" className="image" />
            </Link>

            <h2 className="image__title">Tablets</h2>

            <p className="image__subtitle">0 models</p>
          </div>
          ...
          <div className="category__image" data-cy="categoryLinksContainer">
            ...
            <h2 className="image__title">Accessories</h2>
